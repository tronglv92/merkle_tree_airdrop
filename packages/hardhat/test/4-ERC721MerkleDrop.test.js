...
describe("ERC721MerkleDrop", function () {
  before(async function () {
    ...
    // console.log("Object.entries(tokens) ", Object.entries(tokens));
  ...
  describe("Duplicate mint", function () {
    before(async function () {
      ...
      this.token = {};
      [this.token.tokenId, this.token.account] =
        Object.entries(tokens).find(Boolean);
      this.token.proof = this.merkleTree.getHexProof(
        hashToken(this.token.tokenId, this.token.account)
      );
    });
